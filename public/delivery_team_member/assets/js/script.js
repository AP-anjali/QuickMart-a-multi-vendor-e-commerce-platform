let full_screen_id = document.getElementById("full_screen_id");
...
if($('.zoom-screen .header-nav-list').length>0){$('.zoom-screen .header-nav-list').on('click',function(e){if(!document.fullscreenElement){document.documentElement.requestFullscreen(); full_screen_id.src = "{{ asset('admin/assets/img/icons/fullscreen-exit.svg')}}";}else{if(document.exitFullscreen){document.exitFullscreen(); full_screen_id.src = "{{ asset('admin/assets/img/icons/fullscreen.svg')}}";}}})}
...
//     // Function to handle click events on sidebar menu items
//     $('#sidebar-menu a').on('click', function (e) {
//         e.preventDefault(); // Prevent default link behavior

//         // Extract the route from the 'href' attribute
...
$('.zoom-screen .header-nav-list').on('click', function () {
    var full_screen_id = document.getElementById('full_screen_id');

    if (!document.fullscreenElement) {
        document.documentElement.requestFullscreen();
        full_screen_id.src = "/admin/assets/img/icons/fullscreen-exit.svg";
    } else {
        if (document.exitFullscreen) {
            document.exitFullscreen();
            full_screen_id.src = "/admin/assets/img/icons/fullscreen.svg";
        }
    }
});
