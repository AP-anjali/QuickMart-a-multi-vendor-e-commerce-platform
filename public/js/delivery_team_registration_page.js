...
function validateStage2() {
    var vehicle_rc_book = document.getElementById("vehicle_rc_book").files;
    var vehicle_puc = document.getElementById("vehicle_puc").files;
    var vehicle_licence = document.getElementById("vehicle_licence").files;
    var vehicle_insurance = document.getElementById("vehicle_insurance").files;

    if (vehicle_rc_book.length === 0 || vehicle_puc.length === 0 || vehicle_licence.length === 0 || vehicle_insurance.length === 0) {
