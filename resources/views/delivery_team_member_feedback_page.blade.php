...
@include('website_menu')
    ...
    <section class="teachers">
        <h1 class="heading" style = "margin-top: 45px; margin-bottom: -30px;">Hello, "{{$delivery_team_member_session->name}}"</h1>
    </section>
    ...
    <div id="feedback_form_body">
        ...
        <div class="wrapperanjali">
            <h1>How would you rate to <b>QUICKMART</b> ?</h1>
            <form action="{{ route('delivery_team_member_feedback_form_submission', $delivery_team_member_session->id) }}" method = "post">
                @csrf
                <div class="rating">
