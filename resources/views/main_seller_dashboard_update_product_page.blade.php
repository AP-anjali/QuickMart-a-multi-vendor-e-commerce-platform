...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            <!-- <div>Hello From main_seller_dashboard_update_product_page</div><br> -->

            @if(Session()->has('update_product_route_msg'))

                <div class="msg" id="msg1">
                    {{session()->get('update_product_route_msg')}}
            ...
            <div class="container">
                <div class="login-link" id = "loginLink">
                    ...
                    <p class="primary-bg-text">Update Your Products Attributes<br>With All The Required Informations</p>
                    <a onclick="return confirm('Are you sure to Exit From Product Editing !')" href="{{ route('main_seller_dashboard_show_all_products_page') }}" class="loginbtn">Exit</a>
                </div>
                <form action="{{ route('seller_update_products_form_submission_route', $product_to_update->id) }}" method = "post" class="signup-form-container" enctype="multipart/form-data">
                    @csrf
                    <p class="big-headning">Edit Your Product</p>
...
<script>
    ...
    document.getElementById('mainImageBtn').addEventListener('click', function() {
        ...
        window.location.href = '/main_seller_dashboard/main_seller_dashboard_update_product_page/' + id_for_updatepage_url + '/show_main_image_for_update_product_page/' + productId;
    });

    document.getElementById('otherImagesBtn').addEventListener('click', function() {
        var id_for_updatepage_url = {{ $product_to_update->id }}; 
        var productId = {{ $product_to_update->id }}; 
        window.location.href = '/main_seller_dashboard/main_seller_dashboard_update_product_page/' + id_for_updatepage_url + '/show_other_images_for_update_product_page/' + productId;
    });
