...
@include('website_menu')
    ...
    <section class="teachers">
        <h1 class="heading" style = "margin-top: 45px; margin-bottom: -30px;">Hello, "{{$seller_session->name}}"</h1>
    </section>
    ...
    <div id="feedback_form_body">
        ...
        <div class="wrapperanjali">
            ...
            <form action="{{ route('sellers_feedback_form_submission', $seller_session->id) }}" method = "post">
                @csrf
                <div class="rating">
