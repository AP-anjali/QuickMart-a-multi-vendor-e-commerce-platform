...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('cssfiles/employee_registration_page.css') }}">
...
<body>
    <div class="container">
        <div class="login-link" id = "loginLink">
            ...
            <a href="{{ route('employee_login_page_first_step') }}" class="loginbtn">Login</a>
        </div>
        <form action="{{ route('employee_application_form_submission_route') }}" method = "post" class="signup-form-container" enctype="multipart/form-data">
            @csrf
            <p class="big-headning">Apply For Employment</p>
            ...
            <div class="progress-bar">
                ...
                <div class="stage">
                    <p class="tool-tip" style = "white-space: nowrap;">Qualification Info</p>
            ...
            <div class="signup-form-content">
                ...
                <div class="stage2-content">
                    <div class="button-container">
                        <div class="text-fields percentage_of_twelve" style = "width: 290px;">
                            <label for="percentage_of_twelve"><i class='bx bxs-user' style='color:#6487cb'></i></label>
                            <input type="number" name="percentage_of_twelve" id="percentage_of_twelve" placeholder="Your 12th percentage" required>
                        </div>
                        <div class="file_uploaderpercentage">
                            <label for="proof_of_percentage_of_twelve"><i  class='bx bxs-folder-open' style='color:#6487cb'></i></label>
                            <input type="file" name="proof_of_percentage_of_twelve" id="proof_of_percentage_of_twelve" required>
                        </div>
                        <div class="file_uploader_headingadgpercentage">Marksheet</div>
                    </div>
                    <div class="button-container" style="margin-top: 50px; text-align: center; align-items: center; justify-content: center;">
                        <div class="custome-text-fields other_educational_details">
                            <textarea name="other_educational_details" id="other_educational_details" placeholder="Other Educational Achivements ...!" style="width: 300px !important; height: 120px !important;"></textarea>
                        </div>
                    </div> 
                    <div class="file_uploader_headingotherdetails">Other Details *</div>
                    <div class="confirmation_of_computer_knowlege-container">
                        <label for="confirmation_of_computer_knowlege" class="confirmation_of_computer_knowlege">
                            <input type="checkbox" name="confirmation_of_computer_knowlege" id="confirmation_of_computer_knowlege">
                            I Have Basic Knowledge Of Computer !
                        </label>
                    </div>
                    <div class="pagination-btns">
...
<script src="{{ asset('js/employee_registration_page.js') }}"></script>
