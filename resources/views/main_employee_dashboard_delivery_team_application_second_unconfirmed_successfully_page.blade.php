...
<head>
    ...
    <title>Unconfirmed 2nd Successfully</title>
</head>
<body>
    <div class="container">
    ...
    <script>
        ...
        function goback(){
            window.location.replace("/main_employee_dashboard/main_employee_dashboard_show_all_delivery_team_applications_eligible_by_employee_page");
        }
    </script>
</body>
</html>