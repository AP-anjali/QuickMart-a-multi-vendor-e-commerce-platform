...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            @if(count($all_delivery_team_applications_eligible_by_employee) > 0)
            <div class="center">
                <h2 id="main-heading">All Delivery Team Applications Eligible From Employee</h2>
                ...
                <div class="table_container">
                    <table id="cat_table">
                        ...
                        @foreach($all_delivery_team_applications_eligible_by_employee as $each_delivery_team_application)
                            <tr id="all_rows">
                                <td>{{ $srNo++ }}</td>  
                                ...
                                <td><a onclick="return confirm('Are you sure to Confirm selected Delivery Applicant Application !')" href="{{ route('confirming_delivery_team_application_from_admin_second_step', $each_delivery_team_application->id) }}" id="Confirm_btn">Confirm</a></td> 
                                <td><a onclick="return confirm('Are you sure to Delete selected Delivery Applicant Application !')" href="#" id="delete_btn">Delete</a></td> 
                            </tr>
                        @endforeach
            ...
            @else
                <script>
                    window.location.href = '{{ route('main_admin_dashboard_nothing_to_show_in_delivery_team_applications_eligible_by_employee_page') }}';
                </script>
            @endif
        </div>
    </div>
