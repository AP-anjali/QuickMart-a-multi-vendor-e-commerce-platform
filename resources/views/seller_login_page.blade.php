...
<body>
    <div class="container">
        ...
        @if(session('showSellerLoginAlert'))
                <script>
                    alert('To access further pages, please login first');
                    {!! session()->forget('showSellerLoginAlert') !!}
                </script>
        @endif
        ...
        <div class="login-link">
            ...
            <a href="{{ route('seller_registration_page') }}" class="loginbtn">Register Now</a>
        </div>
        ...
        <div class="signup-form-container">
            ...
            <form action="{{ route('seller_login_form_phone_no_submission_route') }}" method = "post" class="signup-form-container" enctype="multipart/form-data">
                @csrf
                <?php
                    $mno=old('phone_no');
            ...
            <form action="{{ route('seller_login_otp_verification_route') }}" method = "post" class="signup-form-container" enctype="multipart/form-data">
                @csrf
