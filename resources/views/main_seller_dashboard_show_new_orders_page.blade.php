...
<section class="teachers">
   <h1 class="heading" style = "margin-top: 20px; margin-bottom: 30px;">Your New Order Records !</h1>
</section>

    @if(Session()->has('order_accepted'))
        <div class="msg" id="msg1">
            {{session()->get('order_accepted')}}
                    ...
                    <div class="product-card" data-product-id="{{ $each_order->id }}" style = "width: 30%; padding-bottom: 20px;">
                        ...
                        <div class="product-details" style = "position : absolute; margin-left: 380px; margin-top: -280px;">
                            ...
                            <div class="buy_cart_container" style = "margin-top: 20px;">
                                <a onclick="return confirm('Are You Sure To Accept The Order With Name : {{$each_order->product->product_name}} From Your Order List !')" href="{{ route('accept_order_from_seller', $each_order->id) }}"><button class="cart_btn add-to-cart-button">Accept Order</button></a>
