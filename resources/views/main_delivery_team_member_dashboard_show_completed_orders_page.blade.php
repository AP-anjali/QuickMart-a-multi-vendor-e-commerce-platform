...
<head>
   ...
   <title>Delivery Team Member Completed Orders</title>
...
<section class="teachers">
   <h1 class="heading" style = "margin-top: 20px; margin-bottom: 30px;">Your Completed Delivery Records !</h1>
</section>

    <div class="all_product_image_container" style = "padding-left: 20px;">

        @if(count($all_completed_orders) > 0)
            @foreach($all_completed_orders as $each_order)
        ...
        @else
            <div class="container">
                ...
                <h2>No any order completed yet</h2>
            </div>
        @endif
    </div>
