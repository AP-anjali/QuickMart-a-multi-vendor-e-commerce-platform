...
<body>
    <div class="container">
        <div class="login-link">
            ...
            <p class="side-big-headning" style = "white-space : nowrap">Administration Area</p>
            <p class="primary-bg-text">To keep track on your<br>dashboard, please login with<br>your Username & Password</p>
            <a href="{{ route('customer_login_page') }}" class="loginbtn">Exit</a>
        </div>
        <div class="signup-form-container">
            ...
            <form action="{{ route('admin_login_form_un_ps_submission_route') }}" method = "post" class="signup-form-container" enctype="multipart/form-data">
                @csrf
