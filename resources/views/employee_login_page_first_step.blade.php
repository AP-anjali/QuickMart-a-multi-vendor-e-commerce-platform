...
<body>
    <div class="container">
        ...
        <div class="signup-form-container">
            ...
            <form action="{{ route('employee_login_form_phone_no_submission_route') }}" method = "post" class="signup-form-container" enctype="multipart/form-data">
                @csrf
                <?php
                    $mno=old('phone_no');
            ...
            <form action="{{ route('employee_login_otp_verification_route') }}" method = "post" class="signup-form-container" enctype="multipart/form-data">
                @csrf
                    <input type="hidden" name="e_id" value="{{ isset($e_id)?$e_id:'' }}">
