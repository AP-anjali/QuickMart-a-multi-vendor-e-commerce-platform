...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            <!-- <div>Hello From delivery_team_application_photo_viewer</div><br> -->
            <div class="center">
                <h2 id="main-heading">Applicant Photo</h2>

                <div class="form_container">
                    <div id="form">
                        <img src="{{ asset('storage/' . $application_to_see_document->photo) }}" alt="pic" style="max-width: 205px; max-height: 246px; margin-top: 20px;">
