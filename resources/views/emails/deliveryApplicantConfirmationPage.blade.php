...
<head>
    ...
    <title>Delivery Applicant Confirmation</title>
    <style>
        #create_account_btn{
...
<body>
    <div>
        ...
        <h3>You are finally confirmed for Delivery Job From QUICKMART</h3>
        ...
        <a href="{{ route('confirmed_delivery_applicant_account_creation_first_page') }}" id = "create_account_btn">Create Account</a>
