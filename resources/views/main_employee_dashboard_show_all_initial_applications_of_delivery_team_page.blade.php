...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
                ...
                <div class="table_container">
                    <table id="cat_table">
                        <tr id="header_row">
                            ...
                            <td>To Confirm to Applicant at First Step</td>
                        ...
                        @foreach($all_delivery_team_initial_applications as $each_delivery_team_application)
                            <tr id="all_rows">
                                ...
                                <td>{{ $each_delivery_team_application->employee_username ?? '-----------'  }}</td>
                                <td>{{ $each_delivery_team_application->employee_confirm_password ?? '-----------'  }}</td> -->
                                ...
                                <td><a onclick="return confirm('Are you sure to Confirm selected Employee Application !')" href="{{ route('confirming_delivery_team_application_from_employee_first_step', $each_delivery_team_application->id) }}" id="Confirm_btn">Confirm</a></td>
            ...
            @else
                <script>
                    window.location.href = '{{ route('main_employee_dashboard_nothing_to_show_in_initial_delivery_team_applications') }}';
                </script>
            @endif
        </div>
    </div>
