...
<head>
   ...
   <title>Delivery Team Member New Orders</title>
...
<section class="teachers">
   <h1 class="heading" style = "margin-top: 20px; margin-bottom: 30px;">New Delivery Records !</h1>
</section>

    @if(Session()->has('delivery_claimed'))
        <div class="msg" id="msg1">
            {{session()->get('delivery_claimed')}}
    ...
    <div class="all_product_image_container" style = "padding-left: 20px;">
        ...
        @if(count($all_new_orders) > 0)
            @foreach($all_new_orders as $each_order)
                    ...
                    <div class="product-card" data-product-id="{{ $each_order->id }}" style = "width: 30%; padding-bottom: 20px;">
                        ...
                        <div class="product-details" style = "position : absolute; margin-left: 380px; margin-top: -280px;">
                            ...
                            <div class="buy_cart_container" style = "margin-top: 20px;">
                                <a onclick="return confirm('Are You Sure To claim the delivery With Name : {{$each_order->product->product_name}} From all delivery List !')" href="{{ route('claim_delivery_from_delivery_team_member', $each_order->id) }}"><button class="cart_btn add-to-cart-button">Claim Delivery</button></a>
                            </div>
                        </div>
                    </div>
