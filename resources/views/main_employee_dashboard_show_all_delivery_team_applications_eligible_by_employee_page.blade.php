...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="center">
                ...
                <div class="table_container">
                    <table id="cat_table">
                        ...
                        @foreach($all_delivery_team_applications_confirmed_by_admin as $each_delivery_team_application)
                            <tr id="all_rows">
                                <td>{{ $srNo++ }}</td>  
                                ...
                                <td><a onclick="return confirm('Are you sure to Unconfirm selected Delivery Applicant Application !')" href="{{ route('unconfirming_delivery_team_application_from_employee_second_step', $each_delivery_team_application->id) }}" id="delete_btn">Unconfirm</a></td> 
                            </tr>
                        @endforeach
            ...
            @else
                <script>
                    window.location.href = '{{ route('main_employee_dashboard_nothing_to_show_in_delivery_team_applications_eligible_by_employee_page') }}';
                </script>
            @endif
        </div>
    </div>
