...
<body>
    <div class="container">
        ...
        <form id = "first_form" action="{{ route('delivery_applicant_account_creation_first_step_submission_route') }}" method = "post" class="signup-form-container" enctype="multipart/form-data">
            @csrf
