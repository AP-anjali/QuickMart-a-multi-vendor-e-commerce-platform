...
<section class="teachers">
   <h1 class="heading" style = "margin-top: 20px; margin-bottom: 30px;">Your cancelled Order Records !</h1>
</section>

    @if(Session()->has('order_gatted'))
        <div class="msg" id="msg1">
            {{session()->get('order_gatted')}}
    ...
    <div class="all_product_image_container" style = "padding-left: 20px;">
                    ...
                    <div class="product-card" data-product-id="{{ $each_order->id }}" style = "width: 30%; padding-bottom: 20px;">
                        ...
                        <div class="product-details" style = "position : absolute; margin-left: 380px; margin-top: -280px;">
                            ...
                            <div class="buy_cart_container" style = "margin-top: 20px;">
                                <a onclick="return confirm('Are You Sure To get the order in your new orders list With Name : {{$each_order->product->product_name}} From Your Cancelled Order List !')" href="{{ route('get_order_in_order_list_from_cancelled_orders_from_seller', $each_order->id) }}"><button class="cart_btn add-to-cart-button">Get In Order List</button></a>
                            </div>
                        </div>
                    </div>
        ...
        @else
            <div class="container">
                ...
                <h2>No any order cancelled yet</h2>
            </div>
        @endif
    </div>
