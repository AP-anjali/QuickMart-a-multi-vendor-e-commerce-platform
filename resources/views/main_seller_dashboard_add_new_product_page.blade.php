...
<style>
    ...
    *{
    ...
    .text-fields.product_price::after{
        content: 'Product Price with discount';
        background-color: #fff;
        position: relative;
        padding: 0 4%;
        left: -215px;
    ...
    .text-fields.discount_price::after{
        content: 'Product Price without discount';
        background-color: #fff;
        position: relative;
        padding: 0 4%;
        left: -215px;
...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            <!-- <div>Hello From main_seller_dashboard_add_new_product_page</div><br> -->

            @if(Session()->has('add_product_route_msg'))

                <div class="msg" id="msg1">
                    {{session()->get('add_product_route_msg')}}
            ...
            <div class="container">
                <div class="login-link" id = "loginLink">
                    ...
                    <p class="side-big-headning" style="text-align: center;">Product Listing</p>
                    <p class="primary-bg-text">Upload Your Products<br>With All The Required Informations</p>
                    <a href="{{ route('main_seller_dashboard') }}" class="loginbtn">Exit</a>
                </div>
                <form action="{{ route('seller_add_new_products_form_submission_route') }}" method = "post" class="signup-form-container" enctype="multipart/form-data">
                    @csrf
                    <p class="big-headning">Add New Product</p>
                    ...
                    <div class="signup-form-content">
                        <div class="stage1-content">
                            <div class="button-container">
                                <div class="text-fields product_name">
                                    ...
                                    <input type="text" name="product_name" id="product_name" placeholder="Name of the Product" required>
                                </div>
                                <div class="text-fields product_brand">
                                    <label for="product_brand"><i class='bx bx-envelope' style='color:#6487cb'></i></label>
                                    <input type="text" name="product_brand" id="product_brand" placeholder="Your product brand" required>
                                </div>
                            </div>
                            <div class="button-container">
                                ...
                                <div class="text-fields product_description">
                                    ...
                                    <input type="text" name="product_description" id="product_description" placeholder="Your product description" required>
                                </div>
                            </div>
                            <div class="button-container">
                                ...
                                <div class="text-fields discount_price">
                                    ...
                                    <input type="number" name="discount_price" id="discount_price" placeholder="Price without discount" required>
                                </div>

                                <div class="text-fields product_price">
                                    <label for="product_price"><i class='bx bx-phone-call' style='color:#6487cb'></i></label>
                                    <input type="number" name="product_price" id="product_price" placeholder="Price with discount" required>
                                </div>
                        ...
                        <div class="button-container">
                                <div class="text-fields product_quantity">
                                    ...
                                    <input type="number" name="product_quantity" min="0" id="product_quantity" placeholder="Quantity of the product" required>
                                </div>
                            ...
                            <div class="button-container">
                                <div class="text-fields product_keywords">
                                    ...
                                    <input type="text" name="product_keywords" id="product_keywords" placeholder="product Keywords for SEO" required>
                                </div>
                                <div class="text-fields product_color">
                                    <label for="product_color"><i class='bx bxl-periscope' style='color:#6487cb' ></i></label>
                                    <input type="text" name="product_color" id="product_color" placeholder="Your product color">
                                </div>
                            </div>
                            <div class="button-container">
                                <div class="text-fields product_size">
                                    <label for="product_size"><i class='bx bx-phone-call' style='color:#6487cb'></i></label>
                                    <input type="text" name="product_size" id="product_size" placeholder="Size of your product">
                                </div>
                                <div class="text-fields product_weight">
                                    <label for="product_weight"><i class='bx bxl-periscope' style='color:#6487cb' ></i></label>
                                    <input type="number" name="product_weight" id="product_weight" placeholder="Weight of product in Grams">
                                </div>
                            </div>
                            <div class="pagination-btns">
                        ...
                        <div class="stage3-content">
                            <div class="button-container">
                                <div class="text-fields selected_section_name khaskao" style = "width: 290px;">
                                    ...
                                    <select name="selected_section_name" id="my_list" required>
                                        <option value="" selected disabled>Select Product Section&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
                            ...
                            <div class="button-container">
                                <div class="file_uploader">
                                    ...
                                    <input type="file" name="product_main_image" id="product_main_image" required>
                                </div>
...
<script>
    ...
    function validateStage1() {
        ...
        if (product_name === "" || product_brand === "" || product_title === "" || product_description === "" || product_price === "" || discount_price === "") {
    ...
    function validateStage2() {
        ...
        if (product_quantity === "" || selected_category_name === "" || product_keywords === "") {
    ...
    function validateStage3() {
        ...
        var product_main_image = document.getElementById("product_main_image").files;
        var product_other_images = document.getElementById("product_other_images").files;

        if (selected_section_name === "" || product_main_image.length === 0 || product_other_images.length === 0) {
