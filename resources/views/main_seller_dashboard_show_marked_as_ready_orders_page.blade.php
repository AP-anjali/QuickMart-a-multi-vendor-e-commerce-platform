...
<head>
   ...
   <title>Seller Ready Orders</title>
...
<section class="teachers">
   <h1 class="heading" style = "margin-top: 20px; margin-bottom: 30px;">Your Ready Order Records !</h1>
</section>
                    ...
                    <div class="product-card" data-product-id="{{ $each_order->id }}" style = "width: 30%; padding-bottom: 20px;">
                        ...
                        <div class="product-details" style = "position : absolute; margin-left: 380px; margin-top: -280px;">
                            ...
                            <div class="buy_cart_container" style = "margin-top: 20px;">
                                <a onclick="return confirm('Are You Sure To Mark As Pending The Order With Name : {{$each_order->product->product_name}} From Your Order List !')" href="{{ route('mark_order_as_pending_from_seller', $each_order->id) }}"><button class="cart_btn add-to-cart-button">Mark As Pending</button></a>
                            </div>
                        </div>
                    </div>
