...
@section('title')
<title>Employee Application Management</title>
@endsection
...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            <!-- <div>Hello From main_admin_dashboard_show_all_employee_application_page</div><br> -->
            ...
            <div class="center">
                <h2 id="main-heading">All Employees Applications</h2>
                    ...
                    <table id="cat_table">
                        ...
                        @foreach($all_employees as $each_employee)
                            <tr id="all_rows">
                                ...
                                <td><a onclick="return confirm('Are you sure to Confirm selected Employee Application !')" href="{{ route('confirming_employee_application_from_admin', $each_employee->id) }}" href="#" id="Confirm_btn">Confirm</a></td>
            ...
            @else
                <script>
                    window.location.href = '{{ route('main_admin_dashboard_nothing_to_show_in_employees_application_record') }}';
                </script>
            @endif
        </div>
    </div>
