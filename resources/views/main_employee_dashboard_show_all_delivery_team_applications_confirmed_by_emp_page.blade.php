...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            @if(count($all_delivery_team_applications_confirmed_by_emp) > 0)
            <div class="center">
                <h2 id="main-heading">All Delivery Team Applications Confirmed By Employee</h2>
                ...
                <div class="table_container">
                    <table id="cat_table">
                        ...
                        @foreach($all_delivery_team_applications_confirmed_by_emp as $each_delivery_team_application)
                            <tr id="all_rows">
                                <td>{{ $srNo++ }}</td>  
                                ...
                                <td><a onclick="return confirm('Are you sure to Confirm selected Employee Application !')" href="{{ route('unconfirming_delivery_team_application_from_employee_first_step', $each_delivery_team_application->id) }}" id="delete_btn">Unconfirm</a></td> 
                            </tr>
                        @endforeach
            ...
            @else
                <script>
                    window.location.href = '{{ route('main_employee_dashboard_nothing_to_show_in_delivery_team_applications_confirmed_by_emp_page') }}';
                </script>
            @endif
        </div>
    </div>
