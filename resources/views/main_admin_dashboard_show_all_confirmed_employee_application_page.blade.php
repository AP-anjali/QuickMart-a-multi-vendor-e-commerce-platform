...
<style>
    ...
    #Confirmed_Applications_employee{
...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            @if(count($all_confirmed_employees) > 0)
            <div class="center">
                ...
                <div class="table_container">
                    <table id="cat_table">
                        ...
                        @foreach($all_confirmed_employees as $each_employee)
                            <tr id="all_rows">
                                <td>{{ $srNo++ }}</td>  
                                ...
                                <td><a onclick="return confirm('Are you sure to Unconfirm selected Employee Application !')" href="{{ route('unconfirming_employee_application_from_admin', $each_employee->id) }}" href="#" id="delete_btn">Unconfirm</a></td>
                            </tr>
                        @endforeach
            ...
            @else
                <script>
                    window.location.href = '{{ route('main_admin_dashboard_nothing_to_show_in_confirmed_employees_application_record') }}';
                </script>
            @endif
        </div>
    </div>
