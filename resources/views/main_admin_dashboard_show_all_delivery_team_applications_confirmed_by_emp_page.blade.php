...
@section('body')
    <div class="page-wrapper">
        <div class="content container-fluid">
                    ...
                    <table id="cat_table">
                        ...
                        @foreach($all_delivery_team_applications_confirmed_by_emp as $each_delivery_team_application)
                            <tr id="all_rows">
                                ...
                                <td><a onclick="return confirm('Are you sure to Confirm selected Delivery Applicant Application !')" href="{{ route('confirming_delivery_team_application_from_admin_first_step', $each_delivery_team_application->id) }}" id="Confirm_btn">Confirm</a></td> 
            ...
            @else
                <script>
                    window.location.href = '{{ route('main_admin_dashboard_nothing_to_show_in_delivery_team_applications_confirmed_by_emp_page') }}';
                </script>
            @endif
        </div>
    </div>
